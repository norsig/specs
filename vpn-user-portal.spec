...
cp %{SOURCE2} src/fkooman/VpnPortal/autoload.php
sed -i "s|require_once dirname(__DIR__).'/vendor/autoload.php';|require_once '%{_datadir}/fkooman/VpnPortal/src/autoload.php';|" bin/vpn-user-portal-init
sed -i "s|require_once dirname(__DIR__).'/vendor/autoload.php';|require_once '%{_datadir}/fkooman/VpnPortal/src/autoload.php';|" web/index.php
